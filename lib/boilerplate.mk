...
# Define the tracking shell (you can redefined in your Makefile)
...
# WARNING: Order is important. has to be the last target in this dependency list!
# NOTE: it should be the same ones as you can find in the `config/night_shift.sh`.
backup::
